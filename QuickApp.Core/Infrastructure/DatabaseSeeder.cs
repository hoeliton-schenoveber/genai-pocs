        ...
        private async Task SeedDemoDataAsync()
        {
            if (!await dbContext.Customers.AnyAsync() && !await dbContext.ProductCategories.AnyAsync())
            {
                ...
                var prod_1 = new Product
                {
                    ...
                    UnitsInStock = 12,
                    IsActive = true,
                    Icon = "https://upload.wikimedia.org/wikipedia/commons/8/8e/2017-03-07_Geneva_Motor_Show_0996.JPG",
                ...
                var prod_2 = new Product
                {
                    ...
                    UnitsInStock = 4,
                    IsActive = true,
                    Icon = "https://img-ik.cars.co.za/news-site-za/images/2023/10/BB-Group_Blackhawk_2048x13654.jpg",
                    ProductCategory = prodCat_1
                };

                var prod_3 = new Product
                {
                    Name = "Tesla Model S",
                    ...
                    UnitsInStock = 9,
                    IsActive = true,
                    Icon = "https://hips.hearstapps.com/hmg-prod/images/2024-tesla-model-s-107-6572200e43fa1.jpg",
                    ProductCategory = prodCat_1
                };
